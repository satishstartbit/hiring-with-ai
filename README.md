...
Instead of `CAL_EVENT_TYPE_ID`, you can use `CAL_EVENT_TYPE_SLUG` with either `CAL_USERNAME` or `CAL_TEAM_SLUG`. Optional variables: `CAL_ORGANIZATION_SLUG`, `CAL_BOOKING_LENGTH_MINUTES`, and `CAL_BOOKINGS_API_VERSION`.
